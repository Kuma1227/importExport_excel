...
require 'exportExcel_source/vendor/autoload.php';
...
while ($data = mysqli_fetch_array($sql)) { // Ambil semua data dari hasil eksekusi $sql
    ...
    $sheet->setCellValue('C' . $row, $data['pendidikan']);
    $sheet->setCellValue('D' . $row, $data['nama_sekolah']);
    // Khusus untuk no telepon. kita set type kolom nya jadi STRING
    $sheet->setCellValueExplicit('E' . $row, $data['tahun_ijazah'], \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
    $sheet->setCellValue('F' . $row, $data['negara']);
